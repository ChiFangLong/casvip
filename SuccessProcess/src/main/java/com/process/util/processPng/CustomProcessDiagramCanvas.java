...
public class CustomProcessDiagramCanvas {
	...
	// Colors
	protected static Color			TASK_BOX_COLOR					= new Color(249, 249, 249);		//任务框
	...
	protected static Color			HIGHLIGHT_COLOR					= Color.red;	// 高光颜色
	protected static Color			LABEL_COLOR						= new Color(247,42,20);	// 文字颜色
	protected static Color			TASK_BORDER_COLOR				= new Color(187, 187, 187);
	protected static Color			EVENT_BORDER_COLOR				= new Color(88, 88, 88);	// 事件边缘颜色
